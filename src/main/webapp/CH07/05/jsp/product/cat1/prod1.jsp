...
<body>
	...
	<form action="" class="prod1-item">
		<input type="hidden" name="itemname" value="여성상의">
	...
	<form action="" class="prod1-item">
		<input type="hidden" name="itemname" value="가방">
	...
	<form action="" class="prod1-item">
		<input type="hidden" name="itemname" value="시계">
	...
	<form action="" class="prod1-item">
		<input type="hidden" name="itemname" value="팔찌">
